...
-(id)initWithSize:(CGSize)size
{
    if (self = [super initWithSize:size])
    {
        ...
        /* start the mic */
        _audioController = [[AudioController alloc] init:44100 FrameSize:16384];
        _bufferManager = [_audioController getBufferManagerInstance];
        _l_fftData = (Float32*) calloc(16384, sizeof(Float32));
        _l_cepstrumData = (Float32*) calloc(16384, sizeof(Float32));
        _l_fftcepstrumData = (Float32*) calloc(16384, sizeof(Float32));
        _Hz120 = floor(120*(float)16384/(float)44100);
        _Hz530 = floor(530*(float)16384/(float)44100);
