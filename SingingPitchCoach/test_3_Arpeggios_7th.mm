    ...
    if (self = [super initWithSize:size])
    {
        ...
        for(int i=0; i<7; i++)
        {
            switch (i)
            {
                ...
                case 3:        soundFilePath = [[NSBundle mainBundle] pathForResource:@"E4_4" ofType: @"wav"];       break;
                case 4:        soundFilePath = [[NSBundle mainBundle] pathForResource:@"F4_4" ofType: @"wav"];       break;
                case 5:        soundFilePath = [[NSBundle mainBundle] pathForResource:@"ready" ofType: @"wav"];      break;
                case 6:        soundFilePath = [[NSBundle mainBundle] pathForResource:@"go" ofType: @"wav"];         break;
            }
...
-(void)playSound:(NSString *)fileName
{
    ...
    else if ([fileName isEqualToString:@"E4_4"])      { [audioPlayer[3] seekToTime:CMTimeMake(0, 1)];  [audioPlayer[3] play]; }
    else if ([fileName isEqualToString:@"F4_4"])      { [audioPlayer[4] seekToTime:CMTimeMake(0, 1)];  [audioPlayer[4] play]; }
    else if ([fileName isEqualToString:@"ready"])     { [audioPlayer[5] seekToTime:CMTimeMake(0, 1)];  [audioPlayer[5] play]; }
    else if ([fileName isEqualToString:@"go"])        { [audioPlayer[6] seekToTime:CMTimeMake(0, 1)];  [audioPlayer[6] play]; }
}
